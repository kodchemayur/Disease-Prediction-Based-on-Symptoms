    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
        <form method="POST" enctype='multipart/form-data' id="doctorloginform">
          <fieldset>
            <legend class="text-center mainhead"><span class="text-danger">Join</span> Us Doctor</legend>
            <div class="row">
               <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                  <div class="form-group">
                    ...
                    <small id="fileHelp000" class="form-text text-muted">&nbsp*&nbspUpload your latest Photo & Size < 1MB</small>
                  </div>
                </div>
            </div>      
          </fieldset>
